...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_sqlite', 'path' => ($this->targetDirs[2].'/tiendaDB.db'), 'charset' => 'UTF8', 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/PracticaSIBundle/Entity'))), 'PracticaSIBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('PracticaSIBundle' => 'PracticaSIBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_7ec93238bea78bb3f6963240df33003a39810a0de3b90469e70a27208d1e5d02');
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('alvaroberrocal@gmail.com');
        $a->setPassword('bandamostoles');
        $a->setAuthMode(NULL);
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/PracticaSIBundle/Resources/views'), 'PracticaSI');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('571bc51ca88c86.12987687')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'PracticaSIBundle' => 'PracticaSIBundle\\PracticaSIBundle',
            ...
            'database_host' => NULL,
            'database_port' => NULL,
            'database_name' => ($this->targetDirs[3].'/tiendaSI_DB.sqlite'),
            'database_path' => ($this->targetDirs[3].'/tiendaSI_DB.sqlite'),
            'database_user' => NULL,
            'database_password' => NULL,
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => 'alvaroberrocal@gmail.com',
            'mailer_password' => 'bandamostoles',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'alvaroberrocal@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'bandamostoles',
